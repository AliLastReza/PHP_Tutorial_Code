...
<main class="container mt-5">
    <div class="row">
        <div class="col-md-8">
            ...
            $createdAt = mysqli_real_escape_string($conn, $_GET["createdAt"]);
            $sql = "SELECT * FROM posts WHERE title = '$title' AND createdAt = '$createdAt';";
            ...
            if ($resultCount > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <p class="blog-post-meta">' . $row['createdAt'] . ' by ' . $row['author'] . '</a></p>
